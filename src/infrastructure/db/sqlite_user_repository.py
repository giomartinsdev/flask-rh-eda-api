    ...
    def create_user(self, user: User) -> User:
        ...
        with get_db_connection() as conn:
            ...
            cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (
                user.name, user.email, user.is_active, user.phone, user.salary,
                user.position, user.department, user.employment_type, user.manager_id,
                user.hire_date, user.birth_date, user.address
            ))
    ...
    def update_user(self, user_id: int, user: User) -> Optional[User]:
        ...
        with get_db_connection() as conn:
            ...
            ''', (
                user.name, user.email, user.is_active, user.phone, user.salary,
                user.position, user.department, user.employment_type, user.manager_id,
                user.hire_date, user.birth_date, user.address, user_id
            ))
